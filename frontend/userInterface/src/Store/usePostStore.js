...
//                 loading: false,
//                 error: response.userPosts ? null : "No posts found",
//             });
//         } catch (err) {
//             set({
//                 userPosts: [],
...
export const usePostStore = create((set, get) => ({
    ...
    //             console.warn("fetchAllPosts: Expected array, received:", posts);
    //         }
    //         set({
    ...
    //         });
    //     } catch (err) {
    //         console.error("fetchAllPosts error:", err.message, err);
    //         set({
    //             allPosts: [],
    //             loading: false,

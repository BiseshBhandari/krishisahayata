...
// function CartPage() {
//     const { cartItems, totalPrice, cartloading, error, fetchCartItems, increaseCartItem, decreaseCartItem, removeCartItem, clearCart } = useCartStore();
...
//             return;
//         }
//         createOrder(userID, totalPrice, navigate); // ✅ Pass navigate here
...
function CartPage() {
    ...
    const handleOrderNow = async () => {
        ...
        if (response.success) {
            ...
            window.location.href = "/farmer/checkout";
        } else {
